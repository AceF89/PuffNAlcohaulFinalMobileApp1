...
final AutoDisposeChangeNotifierProvider<PastOrdersProvider> pastOrdersProvider =
    ChangeNotifierProvider.autoDispose((ref) => PastOrdersProvider());

class PastOrdersProvider extends DefaultChangeNotifier {
  ...
  Future<List<Order>> getAllOrders({
    ...
    try {
      ...
      var result = await _api.getAllOrders(
        page: _pageNumber,
        status: 'Cancelled,Rejected,PickedUp,Delivered',
