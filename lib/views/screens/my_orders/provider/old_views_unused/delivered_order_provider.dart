...
const String tabType = 'Delivered';

final AutoDisposeChangeNotifierProvider<DeliveredOrdersProvider> deliveredOrdersProvider =
    ChangeNotifierProvider.autoDispose((ref) => DeliveredOrdersProvider());

class DeliveredOrdersProvider extends DefaultChangeNotifier {
  ...
  Future<void> loadMoreOrders() async {
    if (_totalResult != orders.length) {
      var result = await getAllDeliveredOrders(
        isLoadMore: true,
      );
  ...
  Future<List<Order>> getAllDeliveredOrders({
