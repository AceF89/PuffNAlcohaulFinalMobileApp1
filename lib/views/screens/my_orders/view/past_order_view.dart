...
import 'package:alcoholdeliver/views/screens/my_orders/provider/past_order_provider.dart';
...
class _PastOrderViewState extends State<PastOrderView> {
  late PastOrdersProvider _provider;
    ...
    return Expanded(
      child: Consumer(
        builder: (context, ref, _) {
          _provider = ref.watch(pastOrdersProvider);
