...
import 'package:alcoholdeliver/views/screens/my_orders/provider/old_views_unused/all_order_provider.dart';
...
class _AllOrderViewState extends State<AllOrderView> {
  late AllOrdersProvider _provider;
    ...
    return Expanded(
      child: Consumer(
        builder: (context, ref, _) {
          _provider = ref.watch(allOrdersProvider);
