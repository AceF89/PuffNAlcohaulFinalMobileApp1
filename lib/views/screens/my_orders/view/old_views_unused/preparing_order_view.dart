...
import 'package:alcoholdeliver/views/screens/my_orders/provider/old_views_unused/preparing_order_provider.dart';
...
class PreparingOrderView extends StatefulWidget {
  const PreparingOrderView({super.key});
...
class _PreparingOrderViewState extends State<PreparingOrderView> {
  late PreparingOrdersProvider _provider;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      _provider.getAllPreparingOrders();
  ...
  Widget build(BuildContext context) {
    return Consumer(
      builder: (context, ref, _) {
        _provider = ref.watch(preparingOrdersProvider);
