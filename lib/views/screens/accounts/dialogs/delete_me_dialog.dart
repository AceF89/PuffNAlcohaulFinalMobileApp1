...
class DeleteMeDialog extends StatelessWidget {
  const DeleteMeDialog({super.key});

  static Future<bool?> show(BuildContext context) async {
    return await showDialog<bool>(
      context: context,
      barrierDismissible: false,
      builder: (context) => const DeleteMeDialog(),
    );
  }
      ...
      content: SizedBox(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBoxH20(),
            Text(
              'Once you delete your account, it cannot be undeone. All your data will be permanently erased from this app includes your profile information, preference, saved content and any activity history.',
              textAlign: TextAlign.center,
              style: TextStyle(
