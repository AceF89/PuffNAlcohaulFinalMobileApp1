...
final AutoDisposeChangeNotifierProvider<RequestProductProvider> requestProductProvider =
    ChangeNotifierProvider.autoDispose((ref) => RequestProductProvider());

class RequestProductProvider extends DefaultChangeNotifier {
  UserDetails? user;
  ...
  Future<bool> contactUs(BuildContext context) async {
    ...
    if (await ConnectivityService.isConnected) {
      ...
      var result = await _api.contactUs(
