...
final ChangeNotifierProvider<DriverAccountProvider> driverAccountProvider =
    ChangeNotifierProvider((ref) => DriverAccountProvider());

class DriverAccountProvider extends DefaultChangeNotifier {
  UserDetails? oldUser;
  ...
  void updateLocalUser(UserDetails n) {
    final oldSavedUser = preferences.getUserProfile();
    final updatedProfile = n.copyWith(token: oldSavedUser?.token);
    preferences.userProfile = updatedProfile;
    oldUser = updatedProfile;
